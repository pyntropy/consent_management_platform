# Получить сборку по атрибутам

## Описание сценария

| Параметр        | Значение                                                                                  |
|:----------------|:------------------------------------------------------------------------------------------|
| Название:       | Идентификация сборки согласий.                                                            |
| Цель:           | Получить id сборки и список дата-сетов необходимых для подписания всех согласий в сборке. |
| Предусловие:    | У клиента есть полисы по которым необходимо принять согласие.                             |
